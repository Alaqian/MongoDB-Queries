...
`mongo <aaz7118q2_pretty_verbose.js`
...
NOTE: I could only get `mongo <aaz7118q2_pretty_verbose.js` to work on command prompt. It did not work on bash or PowerShell.
...
print("`mongo <aaz7118q2_pretty_verbose.js`\n")
...
print("- aaz7118q2_verbose.js: does not use .pretty() to reformat output - with printed comments")
print("\nThe output of running aaz7118q2_verbose.js has been copied into \"aaz7118_Assignment_4.pdf\" with indexing for each query.\n")
print("NOTE: I could only get `mongo <aaz7118q2_pretty.js` to work on command prompt. It did not work on bash or PowerShell.\n")
