...
The output of running "aaz7118q2_pretty_verbose.js" has been copied into "aaz7118_Assignment_4.pdf" with indexing for each query.

NOTE: I could only get `mongo <aaz7118q2_verbose.js` to work on command prompt. It did not work on bash or PowerShell.
...
print("`mongo <aaz7118q2_verbose.js`\n")
print("There are other versions of this script:")
print("- aaz7118q2_pretty_quiet.js: uses .pretty() to reformat output - without printed comments,")
print("- aaz7118q2_quiet.js: does not use .pretty() to reformat output - without printed comments,")
print("- aaz7118q2_pretty_verbose.js: uses .pretty() to reformat output - with printed comments")
print("\nThe output of running aaz7118q2_verbose.js has been copied into \"aaz7118_Assignment_4.pdf\" with indexing for each query.\n")
print("NOTE: I could only get `mongo <aaz7118q2_verbose.js` to work on command prompt. It did not work on bash or PowerShell.\n")
...
print("\n11. Find the restaurants which locate in longitude value less than -95.754168\n")
print("> db.restaurants.find({ \"address.coord.0\": { $lt: -95.754168 } })")
...
print("\n12. Find the restaurants that do not prepare any cuisine of 'American' and their grade score more than 70 and longitude less than -65.754168\n")
print("> db.restaurants.find({ $and: [{ cuisine: { $ne: \"American \" } }, { \"address.coord.0\": { $lt: -65.754168 } }, { \"grades.score\": { $gt: 70 } }] })()")
db.restaurants.find({ 
    $and: [
        { cuisine: { $ne: "American " } }, 
...
print("\n13. Find the restaurants which do not prepare any cuisine of 'American' and achieved a score more than 70 and located in the longitude less than -65.754168. (without using $and operator)\n")
print("> db.restaurants.find({ $nor: [{ cuisine: \"American \" }, { \"address.coord.0\": { $gte: -65.754168 } }, { \"grades.score\": {$not: { $gt: 70 }}}] })()")
db.restaurants.find({ 
    $nor: [
        { cuisine: "American " }, 
...
print("\n14. Find the restaurants which do not prepare any cuisine of 'American ' and achieved a grade point 'A' and not in the borough of Brooklyn, sorted by cuisine in descending order.\n")
print("> db.restaurants.find({cuisine: { $ne: \"American \" }, \"grades.grade\": \"A\", borough: { $ne: \"Brooklyn\" }}).sort( { cuisine: -1 } )()")
db.restaurants.find({
    cuisine: { $ne: "American " },
    "grades.grade": "A",
    borough: { $ne: "Brooklyn" }
...
print("\n 15. Find the restaurant Id, name, borough and cuisine for those restaurants which contain 'Wil' as first three letters for its name.\n")
print("> db.restaurants.find({name: {$regex: /^Wil/}}, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
    name: {$regex: /^Wil/}
}, {
    restaurant_id: 1,
...
print("\n16. Find the restaurant Id, name, borough and cuisine for those restaurants which contain 'ces' as last three letters for its name.\n")
print("> db.restaurants.find({name: {$regex: /ces$/}}, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
    name: {$regex: /ces$/}
}, {
    restaurant_id: 1,
...
print("\n17. Find the restaurant Id, name, borough and cuisine for those restaurants which contain 'Reg' as three letters somewhere in its name.\n")
print("> db.restaurants.find({name: {$regex: /Reg/}}, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
    name: {$regex: /Reg/}
}, {
    restaurant_id: 1,
...
print("\n18. Find the restaurants which belong to the borough Bronx and prepared either American or Chinese dish\n")
print("db.restaurants.find({ borough: \"Bronx\", $or: [ {cuisine: \"American \"}, {cuisine: \"Chinese\"} ] })()")
db.restaurants.find({
    borough: "Bronx",
    $or: [
        {cuisine: "American "},
...
print("\n19. Find the restaurant Id, name, borough and cuisine for those restaurants which belong to the boroughs of Staten Island or Queens or Bronx or Brooklyn.\n")
print("> db.restaurants.find({ borough: {$in: [\"Staten Island\", \"Queens\", \"Bronx\", \"Brooklyn\"]} }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
...
print("\n20. Find the restaurant Id, name, borough and cuisine for those restaurants which are not belonging to the borough Staten Island or Queens or Bronx or Brooklyn\n")
print("> db.restaurants.find({ borough: {$nin: [\"Staten Island\", \"Queens\", \"Bronx\", \"Brooklyn\"]} }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
...
print("\n21. Find the restaurant Id, name, borough and cuisine for those restaurants which achieved a score below 10.\n")
print("> db.restaurants.find({ \"grades.score\": {$lt: 10} }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
    "grades.score": {$lt: 10}
}, {
    restaurant_id: 1,
...
print("\n22. Find the restaurant Id, name, borough and cuisine for those restaurants which prepared dish except 'American' and 'Chinese' or restaurant's name begins with letter 'Wil'.\n")
print("db.restaurants.find({ $and: [ {cuisine: {$ne: \"American \"}}, {cuisine: {$ne: \"Chinese\"}}, {name: {$regex: /^Wil/}} ] }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1})()")
db.restaurants.find({
    $and: [
        {cuisine: {$ne: "American "}},
        {cuisine: {$ne: "Chinese"}},
